"""Entrada dos carros dentro do display X11 privado iniciado pelo servidor."""
import os
import runpy
...
def main():
    ...
    print('DiscoverCars em display virtual: a janela fica fora da sua tela.', flush=True)
    try:
        runpy.run_module('suiteviagem.carros', run_name='__main__')
    finally:
